...
Blockly.WarningIndicator.prototype.createDom = function() {
  ...
  this.iconGroup_ = Blockly.createSvgElement('g',
      {'class': 'blocklyIconGroup', 'fill': "yellow", 'translate':"transform(0,0)"}, this.svgGroup_); // Quizly fill
  ...
  this.iconMark_ = Blockly.createSvgElement('text',
      {'class': 'blocklyWarningIconMark',
       'fill':"black",    // Quizly fill
       'x': Blockly.ErrorIcon.ICON_RADIUS -3, // Quizly: Adjust -3
  ...
  this.iconErrorGroup_ = Blockly.createSvgElement('g',
      {'class': 'blocklyIconGroup', 'fill': "red", 'transform':"translate(55,0)"}, this.svgGroup_); // Quizly fill
